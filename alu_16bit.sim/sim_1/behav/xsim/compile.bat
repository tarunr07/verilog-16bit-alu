...
REM
REM Generated by Vivado on Fri Jan 16 00:40:09 +0530 2026
...
echo "xvlog --incr --relax -prj tb_alu_main_vlog.prj"
call xvlog  --incr --relax -prj tb_alu_main_vlog.prj -log xvlog.log
